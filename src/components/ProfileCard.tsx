...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  const handleNoticePeriodChange = (
        ...
        <div className={styles.profileInfo}>
          ...
          {editMode && editProfile && onChange && (
            ...
            >
              ...
              >
                <InsertDriveFileIcon
                  sx={{ color: "#4361EE", fontSize: 20, marginRight: 1 }}
                />
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                ...
                >
                  {parsing ? (
                    ...
                    <AutoFixHighIcon sx={{ fontSize: 18, marginRight: 1 }} />
                  )}
          ...
          {!editMode && (
            <>
              ...
              {profile.immediatelyAvailable && (
                <p className={styles.immediatelyAvailableText}>
                  <CheckCircleIcon
                    sx={{
                      color: "#059669",
                      fontSize: 18,
                ...
                <div key={idx} className={styles.expEditCard}>
                  <div className={styles.expEditRow}>
                    ...
                    <div className={styles.inputGroup}>
                      ...
                      {experienceErrors && experienceErrors[idx]?.company && (
                        <div className={styles.fieldError}>
                          {experienceErrors[idx].company}
                        </div>
                      )}
                    </div>
                    <div className={styles.expDateGroup}>
                      <div
                        className={styles.inputGroup + " " + styles.expDateRow}
                      >
                        ...
                        <DatePicker
                          ...
                          onChange={(newValue) => {
                            if (newValue) {
                              ...
                              onExperienceChange(idx, "endDate", formattedDate);
                            }
                          }}
            ...
            profile.experience.map((exp, idx) => (
              <div key={idx} className={styles.expViewCard}>
                <div className={styles.expViewHeader}>
                  ...
                  <span className={styles.expViewCompany}>
                    <BusinessCenterIcon
                      sx={{
                        fontSize: 18,
                        verticalAlign: "middle",
                ...
                <div className={styles.expViewDates}>
                  <CalendarMonthIcon
                    sx={{
                      fontSize: 18,
                      verticalAlign: "middle",
                  ...
                  />
                  {exp.startDate ? formatDateForInput(exp.startDate) : ""}
                ...
                <div key={idx} className={styles.expEditCard}>
                  <div className={styles.expEditRow}>
                    ...
                    >
                      <input
                        ...
                        value={edu.college}
                        onChange={(e) =>
                          onEducationChange(idx, "college", e.target.value)
                        }
                      />
                      {educationErrors && educationErrors[idx]?.college && (
                        <div className={styles.fieldError}>
                          {educationErrors[idx].college}
                        </div>
                      )}
                    </div>
                    <div
                    ...
                    <div className={styles.expDateGroup}>
                      ...
                      >
                        ...
                        <DatePicker
                          views={["month", "year"]}
                          value={parseDateFromInput(
                            formatDateForInput(edu.startDate)
                          )}
                          onChange={(newValue) => {
                            if (newValue) {
                              const formattedDate = format(
                        ...
                        <DatePicker
                          ...
                          onChange={(newValue) => {
                            if (newValue) {
                              ...
                              onEducationChange(idx, "endDate", formattedDate);
                            }
                          }}
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(e) =>
                            onEducationChange(idx, "ongoing", e.target.checked)
                          }
                          color="primary"
                        />
                      }
                  ...
                  <div className={styles.expEditRow}>
                    <input
                      ...
                      value={edu.grade}
                      onChange={(e) =>
                        onEducationChange(idx, "grade", e.target.value)
                      }
                    />
                  </div>
                  <div className={styles.expRemoveBtnRow}>
